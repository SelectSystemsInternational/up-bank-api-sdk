...
namespace UpBankApi.Model
{
    ...
    public partial class Category : IEquatable<Category>, IValidatableObject
    {
        ...
        public Category(CategoryResource Data = default(CategoryResource))
        {
            // to ensure "Data" is required (not null)
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for Category and cannot be null");
            }
            else
            {
                this.Data = Data;
        ...
        /// <summary>
        /// Returns true if CategorysList instances are equal
        /// </summary>
        /// <param name="other">Instance of CategorysList to be compared</param>
        /// <returns>Boolean</returns>
