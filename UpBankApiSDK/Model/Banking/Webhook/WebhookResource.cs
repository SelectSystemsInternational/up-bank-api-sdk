...
namespace UpBankApi.Model
{
    ...
    public partial class WebhookResource : IEquatable<WebhookResource>, IValidatableObject
    {
        ...
        /// <param name="Id">WebhookType (required).</param>
        /// <param name="Attributes">Attributes (required).</param> 
        /// <param name="Relationships">Relationships (required).</param> 
        /// <param name="Links">Links (required).</param> 
        /// 
        public WebhookResource(string Type = default, string Id = default, WebhookAttributes Attributes = default,
                                WebhookRelationships Relationships = default, ResourceLinks Links = default)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for WebhookResource  and cannot be null");
            }
            else
            {
                this.Type = Type;
