...
namespace UpBankApi.Model
{
    ...
    public partial class Webhook : IEquatable<Webhook>, IValidatableObject
    {
        ...
        public Webhook(WebhookResource Data = default(WebhookResource))
        {
            // to ensure "Data" is required (not null)
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for Webhook and cannot be null");
            }
            else
            {
                this.Data = Data;
        ...
        /// <returns>Boolean</returns>
        public bool Equals([AllowNull] Webhook other)
        {
            if (other == null)
                return false;
            return
