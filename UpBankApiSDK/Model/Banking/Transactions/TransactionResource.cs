...
namespace UpBankApi.Model
{
    ...
    public partial class TransactionResource : IEquatable<TransactionResource>, IValidatableObject
    {
        ...
        /// 
        public TransactionResource(string Type = default, string Id = default, TransactionAttributes Attributes = default, 
            TransactionRelationships Relationships = default, ResourceLinks Links = default)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for TransactionResource and cannot be null");
            }
            else
            {
                this.Type = Type;
