...
namespace UpBankApi.Model
{
    ...
    public partial class AccountList : IEquatable<AccountList>, IValidatableObject
    {
        ...
        public AccountList(List<AccountResource> Data = default(List<AccountResource>), PageLinks Links = default)
        {
        ...
        {        
            return this.Equals(obj as AccountList);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals([AllowNull] AccountList other)
        {
            if (other == null)
                return false;
            return
